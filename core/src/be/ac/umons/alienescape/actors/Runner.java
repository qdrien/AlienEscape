package be.ac.umons.alienescape.actors;
...
public class Runner extends GameActor {
    ...
    public Runner(Body body, Animation<TextureRegion> runningAnimation, TextureRegion jumpingTexture, TextureRegion dodgingTexture, TextureRegion hitTexture){
        super(body);
        this.runningAnimation = runningAnimation;
        stateTime = 0f;
        this.jumpingTexture = jumpingTexture;
        this.dodgingTexture = dodgingTexture;
