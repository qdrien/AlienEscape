...
/**
 * Shows how to use the @Mock annotation to inject a mock (more readable, easier to debug).
 * The whole class is equivalent to the {@link GameStageTest} class.
 */
public class AlternativeGameStageTest {

    private static HeadlessApplication application;
    private World world;

    /*
    The following line (using the @Mock annotation) can replace the combination of:
    private Contact contact;
    and a manual mock instantiation:
    contact = Mockito.mock(Contact.class);

    But requires a call (e.g. in a SetUp method) to:
    MockitoAnnotations.initMocks(this);
    */
    @Mock private Contact contact;

    @Mock private SpriteBatch batch;
    @Mock private Animation animationMock;
    @Mock private TextureRegion textureMock;
